...
export class _PhysicsSystem<S extends Signals> extends CollisionSystem<C, S> {
  ...
  constructor(options?: Partial<_PhysicsSystem.Options>) {
...
export namespace _PhysicsSystem {
